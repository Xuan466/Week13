...
public class AccountTest {
	public static void main(String []args)
	{
		...
		System.out.println("Mom's saving. " +momsSavings);
		// (10000 - 200) * .5% interest = 8040
		
		System.out.println("The college fund. " +collegeFund);
		// (10000 * 1% interest) *.5% penalty - 980 = 9069.50
	...
	/*
	 *  Handles end-of-month operations. Overloaded method, because checking account 
	 *  does different things than savings account
	 */
	
	/*
	 * Handle end of month interest for a savings account 
	 * @param savings- the saving account to handle 
	 */
